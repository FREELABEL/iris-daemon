...
const OPEN_PATHS = new Set([
  ...
  '/daemon/capacity',
  '/daemon/profile',
  // The phone UI shell (#184810). HTML and JS only — it holds no token and
  // returns none. A browser cannot set a header while navigating, so the page
  // must be reachable without one; every call it then makes is authenticated.
  '/hive/ui'
])
